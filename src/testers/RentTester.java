...
public class RentTester
{
    public static void main(String[] args){
        ...
        if(!r1.getReturnDate().equals(dp1.tomorrow())){
            System.out.println("\tproblem in regular constructor---, the return date shold be " + dp1.tomorrow() + " because the return date is before the pick date, but he was " + r1.getReturnDate());
            isGood = false;
        }
        if(!r2.getReturnDate().equals(dp1.tomorrow())){
            System.out.println("\tproblem in regular constructor---, the return date shold be " + dp1.tomorrow() + "because the return date is the same date with the pick date, but he was " + r2.getReturnDate());
            isGood = false;
        }
        if(isGood)
        ...
        if(isGood)
            System.out.println("\tgetPrice method is good+++");
