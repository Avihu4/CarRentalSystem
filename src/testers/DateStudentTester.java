...
public class DateStudentTester
{
    public static void main(String[] args) {
        ...
        if(d3.before(d4))
             System.out.println("\td3 is before d4");        
        else 
             System.out.println("\td3 isn't before d4");     
        System.out.println("\n5. Testing after method:");
        if(d3.after(d4))
             System.out.println("\td3 is after d4");
        else 
             System.out.println("\td3 isn't after d4");      
